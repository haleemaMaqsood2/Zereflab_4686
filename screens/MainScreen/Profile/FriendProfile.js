            ...
            <SafeAreaView style={styles.safeArea}>
                <ScrollView
                    ...
                    <View style={styles.userInfo}>
                        <Text style={styles.userName}>Cristofer</Text>
                        <Text style={styles.userDetail}><Text style={{fontSize:13,fontWeight:'700',color:color.whiteColor}}>188 </Text> friends <Text style={{fontSize:13,fontWeight:'700',color:color.whiteColor}}>.6 </Text>mutual</Text>
                        ...
                        style={styles.EditProfileButton}>
                             <Image
                            source={require('../../../src/assets/images/Add1x4.png')}
